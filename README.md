...
- télécharcher le fichier executable [Télécharger Weda Companion.exe](https://github.com/Refhi/Weda-Helper-Companion/releases/latest/download/Weda%20Companion.exe) ou dans le dossier de votre choix, et le démarrer
...
Pour les geek :
- vous pouvez directement récupérer le companion (gui.py) et l'executer (avec une limitation : le vol de focus ne peut être contré que via l'exe)
