...
- télécharcher le fichier executable [Télécharger companion.exe](https://github.com/Refhi/Weda-Helper-Companion/blob/v1.0/dist/companion.exe) dans le dossier de votre choix, et le démarrer
