import sys
import os
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QLineEdit, QCheckBox, QPushButton, QVBoxLayout, QFormLayout, QMessageBox
...
class OptionsWindow(QWidget):
    def __init__(self):
        ...
        form_layout.addRow("Démarrer automatiquement:", self.start_at_boot_checkbox)
