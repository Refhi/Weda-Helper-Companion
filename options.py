...
class OptionsWindow(QWidget):
    def __init__(self):
        ...
        form_layout.addWidget(QLabel('<center><i>Doit correspondre à la clé API des options de l\'extension<br>laisser vide pour qu\'elle soit automatiquement récupérée</i></center>'), 1,0,1,2, Qt.AlignmentFlag.AlignCenter)
        ...
        form_layout.addWidget(QLabel('<center><i>A récupérer dans les options de l\'extension \n 4821 par défaut</i></center>'), 5,0,1,2, Qt.AlignmentFlag.AlignCenter)
        ...
        form_layout.addWidget(QLabel('<center><i>A récupérer auprès de votre installateur de TPE<br>(en général 5000 pour verifone et 8888 pour ingenico)</i></center>'), 9,0,1,2, Qt.AlignmentFlag.AlignCenter)
    ...
    def load_options(self):
        ...
        if archive_directory is None or archive_directory == "Corbeille":
